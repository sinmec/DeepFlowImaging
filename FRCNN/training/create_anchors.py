...
def create_anchors(img_size, subsampling_ratio, anchor_ratios, anchor_sizes, img):
    ...
    # Size of the anchors (already divided by the subsampling_ratio)
    # and aspect ratio of the bboxes in each anchor point
    ...
    # Defining the anchor points leftmost and rightmos points
    # X----------
    # |         |
    # |         |
    # |         |
